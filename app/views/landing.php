...
<head>
	...
	<title>Share Mind Partners</title>
...
<body>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
  		<div class="container">
  			<div class="navbar-header">
      			...
      			<a class="navbar-brand" href="#">ShareMindPartners - <small>Software experts</small></a>
    		</div>
	...
	<div class="container page-content">
		...
		<div class="row section-row services-row">
			...
			<div class="row cta-row">
				<h3><a class="btn btn-link btn-lg" href="#" role="button"><i class="fa fa-reply fa-rotate-270"></i> Get in touch with us</a></h3>
			</div>
		...
		<div class="row contact-row">
			<h1 class="section-header">
				Get in touch with us now <br /> and let's get your project rolling!
			</h1>
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<form class="well">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="company" placeholder="Please enter the company name (optional)">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="phoneNo" placeholder="Please enter your phone number" required>
						</div>

						<div class="form-group">
							<label for="message-body">Your message</label>
							<textarea name="message-body" class="form-control" rows="5" placeholder="Tell us how we can help you" required></textarea>
						</div>

						<div class="form-group">
							<input type="submit" class="btn btn-primary btn-submit" value="Send your message">
						</div>
					</form>
					...
					<div class="row alert alert-success">
						<div class= "col-md-12">
							...
							<p>
								You have taken the first step towards a rewarding partnership. We'll look through your message
					...
					<div class="row alert alert-danger">
						<div class= "col-md-12">
							<h2>Hmm... There seems to have been an error.</h2>
							<i class="fa fa-times-circle"></i>
							<p>
								We were unable to send your message. Please accept our apologies. In the meantime, please contact us
								directly at <a href="mailto:info@sharemindpartners.com">info@sharemindpartners.com</a>.
							</p>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="scripts/setLayout.js"></script>
